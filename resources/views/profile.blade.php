                    ...
                    <div class="col-md-6">
                        <div class="card card__course">
                            <div class=" d-flex justify-content-center">
                                <a class="" href="#">
                                    ...
                                    <!-- <img src="assets/images/logos/vuejs.svg" class="mb-1" style="width:80px;" alt="logo" class="rounded"> -->
                                     <img src="{{ asset('images/'.$item->image)}}" style="width:100%; height: 250px;" alt="Social Media">
                            ...
                            <div class="p-3">
                                <div class="d-flex align-items-center">
                                    <div>
                                        <a class="text-body mb-1" href="fixed-#"><strong>{{$item->nom}}</strong></a><br>
                                        <div class="d-flex align-items-center">
                                            
                                            <a href="fixed-take-course.html" class="small">Social Media</a>
                                        </div>
                                    </div>
                                    <a href="{{ route('getCourse', [$item->id, $item->cours->first()->id])}}" class="btn btn-primary ml-auto">Resume <i class="material-icons">arrow_forward</i></a>
                                </div>
                            </div>
                            <div class="progress" style="height: 4px;">
                                <div class="progress-bar bg-primary" role="progressbar" style="width: {{round(count($item->cours->intersect(Auth::user()->cours))/count($item->cours)*100)}}%;" aria-valuenow="{{round(count($item->cours->intersect(Auth::user()->cours))/count($item->cours)*100)}}" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
